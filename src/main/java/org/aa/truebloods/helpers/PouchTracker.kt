package org.aa.truebloods.helpers

import org.aa.truebloods.helpers.Constants.ITEM_COLOSSAL_POUCH
import org.aa.truebloods.helpers.Constants.ITEM_DAEYALT_ESSENCE
import org.aa.truebloods.helpers.Constants.ITEM_GIANT_POUCH
import org.aa.truebloods.helpers.Constants.ITEM_LARGE_POUCH
import org.aa.truebloods.helpers.Constants.ITEM_MEDIUM_POUCH
import org.aa.truebloods.helpers.Constants.ITEM_PURE_ESSENCE
import org.aa.truebloods.helpers.Constants.ITEM_SMALL_POUCH
...
object PouchTracker {
    ...
    var supportedPouches = listOf(
            ...
            Pouch(ITEM_COLOSSAL_POUCH, 4, true),
    )
    ...
    fun updatePouchesToTrack() {
        ...
        System.out.println("Tracking" + pouchesToTrack.map { it.itemName })
    }
