...
public class Areas {
    ...
    public static final Area EDGEVILLE_AREA = new Area(new Tile(3079, 3521, 0), new Tile(3141, 3467, 0));

    public static final Area FAIRY_RING_AREA = new Area(new Tile(3125, 3499, 0), new Tile(3134, 3493, 0));

    public static final Area CAVE_1_AREA = new Area(new Tile(3437, 9828, 0), new Tile(3452, 9821, 0));

    public static final Area CAVE_2_AREA = new Area(
            new Tile(3459, 9809, 0),
            new Tile(3465, 9809, 0),
            new Tile(3468, 9811, 0),
            new Tile(3470, 9812, 0),
            new Tile(3473, 9815, 0),
            new Tile(3473, 9817, 0),
            new Tile(3467, 9823, 0),
            new Tile(3464, 9823, 0),
            new Tile(3461, 9820, 0),
